...
class IndexedImageImporter : public godot::EditorImportPlugin
{
	GDCLASS(IndexedImageImporter, EditorImportPlugin);
...
public:
	IndexedImageImporter();
	~IndexedImageImporter() override = default;
